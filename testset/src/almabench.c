...
static const double a[8][3] = {{0.3870983098, 0, 0},
                               {0.7233298200, 0, 0},
                               {1.0000010178, 0, 0},
...
static const double dlm[8][3] = {{252.25090552, 5381016286.88982, -1.92789},
...
static const double e[8][3] = {{0.2056317526, 0.0002040653, -28349e-10},
...
static const double pi[8][3] = {{77.45611904, 5719.11590, -4.83016},
...
static const double kp[8][9] = {
    {69613.0, 75645.0, 88306.0, 59899.0, 15746.0, 71087.0, 142173.0, 3086.0,
     0.0},
    {21863.0, 32794.0, 26934.0, 10931.0, 26250.0, 43725.0, 53867.0, 28939.0,
     0.0},
    {16002.0, 21863.0, 32004.0, 10931.0, 14529.0, 16368.0, 15318.0, 32794.0,
     0.0},
...
static const double ca[8][9] = {
    ...
    {-23437.0, -2634.0, 6601.0, 6259.0, -1507.0, -1821.0, 2620.0, -2115.0,
     -1489.0},
    {62911.0, -119919.0, 79336.0, 17814.0, -24241.0, 12068.0, 8306.0, -4893.0,
     8902.0},
    {389061.0, -262125.0, -44088.0, 8387.0, -22976.0, -2093.0, -615.0, -9720.0,
     6633.0},
    {-412235.0, -157046.0, -31430.0, 37817.0, -9740.0, -13.0, -7449.0, 9644.0,
     0.0}};
...
static const double sa[8][9] = {
    ...
    {-14614.0, -19828.0, -5869.0, 1881.0, -4372.0, -2255.0, 782.0, 930.0,
     913.0},
    {139737.0, 0.0, 24667.0, 51123.0, -5102.0, 7429.0, -4095.0, -1976.0,
     -9566.0},
    {-138081.0, 0.0, 37205.0, -49039.0, -41901.0, -33872.0, -27037.0, -12474.0,
     18797.0},
    {0.0, 28492.0, 133236.0, 69654.0, 52322.0, -49577.0, -26430.0, -3593.0,
     0.0}};

// tables giving the trigonometric terms to be added to the mean
// elements of the mean longitudes.
static const double kq[8][10] = {
    {3086.0, 15746.0, 69613.0, 59899.0, 75645.0, 88306.0, 12661.0, 2658.0, 0.0,
     0.0},
    {21863.0, 32794.0, 10931.0, 73.0, 4387.0, 26934.0, 1473.0, 2157.0, 0.0,
     0.0},
...
static const double cl[8][10] = {
    ...
    {7610.0, -4997.0, -7689.0, -5841.0, -2617.0, 1115.0, -748.0, -607.0, 6074.0,
     354.0},
    {-18549.0, 30125.0, 20012.0, -730.0, 824.0, 23.0, 1289.0, -352.0, -14767.0,
     -2062.0},
    {-135245.0, -14594.0, 4197.0, -4030.0, -5630.0, -2898.0, 2540.0, -306.0,
     2939.0, 1986.0},
    {89948.0, 2103.0, 8963.0, 2695.0, 3682.0, 1648.0, 866.0, -154.0, -1963.0,
     -283.0}};
...
static const double sl[8][10] = {
    ...
    {-56980.0, 8016.0, 1012.0, 1448.0, -3024.0, -3710.0, 318.0, 503.0, 3767.0,
     577.0},
    {138606.0, -13478.0, -4964.0, 1441.0, -1319.0, -1482.0, 427.0, 1236.0,
     -9167.0, -1918.0},
    {71234.0, -41116.0, 5334.0, -4935.0, -1848.0, 66.0, 434.0, -1748.0, 3780.0,
     -701.0},
    {-47645.0, 11647.0, 2166.0, 3194.0, 679.0, 0.0, -244.0, -419.0, -2531.0,
     48.0}};
...
void planetpv(double epoch[2], int np, double pv[2][3]) {
  ...
  doh = anpm((3600.0 * omega[np][0] + (omega[np][1] + omega[np][2] * t) * t) *
             A2R);
...
void radecdist(double state[2][3], double rdd[3]) {
  // distance
  rdd[2] = sqrt(state[0][0] * state[0][0] + state[0][1] * state[0][1] +
                state[0][2] * state[0][2]);
